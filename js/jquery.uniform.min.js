(function (a) {
    a.uniform = {options: {selectClass: "selector", radioClass: "radio", checkboxClass: "checker", fileClass: "uploader", filenameClass: "filename", fileBtnClass: "action", fileDefaultText: "No file selected", fileBtnText: "Choose File", checkedClass: "checked", focusClass: "focus", disabledClass: "disabled", buttonClass: "button", activeClass: "active", hoverClass: "hover", useID: true, idPrefix: "uniform", resetSelector: false}, elements: []};
    ...
    a.fn.uniform = function (k) {
        ...
        function i(n) {
            ...
            o.bind({"mouseenter.uniform": function () {
        ...
        function e(n) {
            ...
            o = n.parent("div");
            l = n.siblings("span");
            n.bind({"change.uniform": function () {
        ...
        function f(m) {
            ...
            l = m.parent();
            n = l.parent();
            a(m).css("opacity", 0).bind({"focus.uniform": function () {
