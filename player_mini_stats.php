...
$steamid = mysql_real_escape_string($_GET["sid"]);
...
while ($player = mysql_fetch_array($ergebnis)) {
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr>
            ...
            <td>Points per Minute: <?= ($player['PLAYTIME'] != 0) ? round(
                    $player['POINTS'] / $player['PLAYTIME'],
                    2
                ) : '0' ?></td>
        </tr>
        <tr>
            <td>Deaths: <?= $player['Death'] ?></td>
            <td>Kills per Minute: <?= ($player['PLAYTIME'] != 0) ? round(
                    $player['KILLS'] / $player['PLAYTIME'],
                    2
                ) : '0' ?></td>
        </tr>
        <tr>
